...
import a1 from '../ui/700.PNG';
import a2 from '../ui/701.PNG';
import a3 from '../ui/702.PNG';
import a4 from '../ui/703.PNG';
import a5 from '../ui/704.PNG';
import a6 from '../ui/705.PNG';
import a7 from '../ui/706.PNG';
import a8 from '../ui/707.PNG';
import a9 from '../ui/708.PNG';
import a10 from '../ui/709.PNG';
import a11 from '../ui/800.PNG';
import a12 from '../ui/801.PNG';
    ...
    <li>
      <a href="#!">Islamabad Capital Territory(1814)</a>
        ...
        <div className="card-body">
          ...
          <h6 className="card-title">Samsung 24 inches LED</h6>
         </div>
      </div>
      </div>{/*M3*/}
      <div className="M4">
        ...
        <div className="card-body">
          ...
          <h6 className="card-title">New b Samsung Smart Led </h6>
         </div>
      </div>
      </div>{/*M4*/}
      <div className="M5">
        ...
        <div className="card-body">
          <h5 className="card-title">Rs 18,500</h5>
          <h5 className="card-title">Full smart andriod</h5>
         </div>
      </div>
      </div>{/*M5*/}
        ...
        <div className="card-body">
          <h4 className="card-title">Rs 4,999</h4>
          <h6 className="card-title">T9 4gb-32gb android</h6>
         </div>
      </div>
      </div>{/*M3*/}
      <div className="M4">
        ...
        <div className="card-body">
          <h5 className="card-title">Rs 25,000</h5>
          <h6 className="card-title">2day sale offer 42 inch</h6>
         </div>
      </div>
      </div>{/*M4*/}
      <div className="M5">
        ...
        <div className="card-body">
          <h5 className="card-title">Rs 17,999</h5>
          <h5 className="card-title">32" samsung android </h5>
         </div>
      </div>
      </div>{/*M5*/}
        ...
        <div className="card-body">
          <h4 className="card-title">Rs 1,500</h4>
          <h6 className="card-title">new ceiling mount stand </h6>
         </div>
      </div>
      </div>{/*M3*/}
      <div className="M4">
        ...
        <div className="card-body">
          ...
          <h6 className="card-title">Yamaha Soundbars </h6>
         </div>
      </div>
      </div>{/*M4*/}
      <div className="M5">
        ...
        <div className="card-body">
          ...
          <h5 className="card-title">Sharp CD player</h5>
         </div>
      </div>
      </div>{/*M5*/}
        ...
        <div className="card-body">
          <h4 className="card-title">Rs 25,000</h4>
          <h6 className="card-title">AV receiver</h6>
         </div>
      </div>
      </div>{/*M3*/}
      <div className="M4">
        ...
        <div className="card-body">
          <h5 className="card-title">Rs 5,800</h5>
          <h6 className="card-title">ANDROID TV BOX A95X3</h6>
         </div>
      </div>
      </div>{/*M4*/}
      <div className="M5">
        ...
        <div className="card-body">
          <h5 className="card-title">Rs 3,000</h5>
          <h5 className="card-title">DVD ha</h5>
         </div>
      </div>
      </div>{/*M5*/}
