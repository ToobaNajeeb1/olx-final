...
import a1 from '../ui/106.PNG';
import a2 from '../ui/104.PNG';
import a3 from '../ui/105.PNG';
import a4 from '../ui/200.PNG';
import a5 from '../ui/93.PNG';
import a6 from '../ui/102.PNG';
import a7 from '../ui/108.PNG';
...
const Motorcycles=()=>{
    return(
        ...
        <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div className="navbar-nav">
           ...
           {/*navbar*/}
            ...
            <h1>Motorcycles</h1><br/><br/>
           <div>
            <div className="M1">
            <div className="M11">
                <h4>Motorcycles</h4><br/>
            <h6 >filters</h6><br/>
        ...
        <li>
          <a href="#!">khyber pakhtunjhawa(1949)</a>
        </li>
        <li>
          <a href="#!">Islamabad Capital Territory(1548)</a>
        </li>
        <li>
          <a href="#!">Azad Kashmir(246)</a>
        </li>
      </ul>
    
            <h5>MAKE</h5>
            <li className="list-unstyled">
            <a href="#!">Honda(11758)</a>
        </li>
        <li>
          <a href="#!">Other brands(1813)</a>
        </li>
        <li>
          <a href="#!">suzuki(1193)</a>
        </li>
      ...
      <div className="M5">
        ...
        <div className="card-body">
          ...
          <h5 className="card-title">Iphone 7plus</h5>
                          ...
                          <div className="M3">
         <div className="card" style={{width: '15rem'}}>
         <img  src={a4} width="240px" height="140px" alt=""/>
        <div className="card-body">
          <h4 className="card-title">Rs 20,999</h4>
          <h6 className="card-title">Motorola G8 4gb 64gb </h6>
         </div>
      ...
      <div className="M5">
        ...
        <div className="card-body">
         ...
         <div className="M3">
         <div className="card" style={{width: '15rem'}}>
         <img  src={a1} width="240px" height="140px" alt=""/>
        <div className="card-body">
          <h4 className="card-title">Rs 20,999</h4>
          <h6 className="card-title">Motorola G8 4gb 64gb </h6>
         </div>
